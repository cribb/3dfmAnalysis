function v = laser_trap_analysis(filename);


d = load_vrpn_tracking(filename,'u','zero','yes');  %load in data set
...
v.forces.x = k_x * j.trapcentered.x;
v.forces.y = k_y * j.trapcentered.y;
v.forces.z = k_z * j.trapcentered.z;
