...
% LOG_DRIFT collects and logs QPD and photodetector data
%
% 3DFM function  
% Diagnostics 
...
% a file w/ the date and time in the file name.
%  
%  log_drift(adc_collectSeconds, adc_sampleRate);
%   
