...
[msdd_0 flor_0]=msddE( msd2p,minradius,maxradius,0,beadradius,0);
    ...
    msdd_0 = 11111*ones(1,8);
    flor_0 = 11111*ones(1,2);
end
...
[msddq_0 florq_0]=msddE( msd2pq,minradius,maxradius,0,beadradius,0);
    ...
    msddq_0 = 11111*ones(1,8);
    florq_0 = 11111*ones(1,8);
end
...
% commented out because not saving plots
% errorbarlogx
...
% commented out because not using error bars
% errorbarlogx
