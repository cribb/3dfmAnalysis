...
% KV_STEP_FIT fits input data to jeffrey rheological model's step response and provides fitting parameters and R^2 fitness value    
%
% 3DFM function
...
%
   ...
   % set parameters for the options structure sent to lsqcurvefit.
	...
	[fit, resnorm, residuals] = lsqcurvefit('KV_step_fun', x0, t, y, 0, [], options);
