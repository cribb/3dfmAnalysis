...
%        "d" is rod diameter(s) in meters. can be a vector.
...
F = thinning_force_rod(gammadot, d./2, L, lambda, eta0, etainf, m, n);

plotF = fliplr(F);

rod_diameters = [num2str(flipud(d/1e-6)) repmat(' \mum', length(d), 1)];
