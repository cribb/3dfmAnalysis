% HISTORY_DEPENDENCE_EXPT Produces a .mat file that contains input signals used to drive magnets during a history dependence expt
%
% 3DFM function
...
pulse_voltages = [1 1 1 1 1];
start_time = 0;
times_to_activate_pulses = [5 25 35 45 65];
times_to_deactivate_pulses = [10 30 40 50 70];
end_time = 75;
