function plot_ve_2pt(v, freq_type, h, optstring)
...
%        "freq_type" is 'f' for [Hz] or 'w' for [rad/s], default is [rad/s]
%  
...
elseif strcmp(optstring, 'GgNn')
    hold on;
plot(plot_freq,real(loggp),'b')
plot(plot_freq,real(loggpp),'b--')
plot(plot_freq,real(lognp),'r')
plot(plot_freq,real(lognpp),'r--')
    hold off;
