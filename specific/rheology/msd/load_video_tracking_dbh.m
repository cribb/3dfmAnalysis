...
% David is being a bad boy trying to make this work
% lets just see how bad i can mess this up
% 
% load_video_tracking_dbh
% 3DFM function
...
% 	end  
	...
	if(strcmp(absolute_pos,'relative'))
        for k = 1 : num_sensors       
            ...
            xsensor = data(my_sensor,4) - data(my_sensor(1),4);
            ysensor = data(my_sensor,5) - data(my_sensor(1),5);
