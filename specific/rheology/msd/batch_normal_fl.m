...
% elliminate drift for beads collected under fluorescences microscopy on
% Hercules, using the Pulnix camera and the 1.0x optovar
%  
...
% calls batch_msd_2d_n which calculates the mean squared displacement
% curves for all beads in the *.dat file and saves them to *.txt 
% files (1 per *.no_drift.dat file)
batch_msd_2d_n
