...
for z = 1:num_files,
    ...
    %d = load_video_tracking(filename, 120,[],[],'rectangle','um',0.104);% 1.5x
    d = load_video_tracking(filename, 120,[],[],'rectangle','um',0.154,'absolute');%1.0x
