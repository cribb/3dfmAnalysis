function VidTable = pan_mk_file_table(filepath, systemid, plate_type)
...
VidTable = table(Fid, Path, File, Pass, Well, SampleName, Fps, Calibum, Width, Height, Firstframes, Mips);
