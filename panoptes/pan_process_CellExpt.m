...
% PAN_PROCESS_CELLEXPT begins the Monoptes/Panoptes analysis routine for PM experiments
%
% Panoptes function 
% 
% This function contains all of the settings and parameters needed to start
% the analysis for cell-based microrheology experiments using the Monoptes or 
...
[s,mess,messid] = movefile([outf '.mat'], analysis_dir);
...
function logentry(txt)
    ...
    logtimetext = [ '(' num2str(logtime(1),  '%04i') '.' ...
     ...
     headertext = [logtimetext 'pan_process_CellExpt: '];
