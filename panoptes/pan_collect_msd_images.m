function outs = pan_collect_msd_images(panoptes_resultsfile, order_var)
...
%     old_FLburst_filename = [mydir '/' myfile];
    ...
    if isempty(png_files)
        im = imread(myfile);    
        imwrite(im, [collection_dir '/' new_filename,'_group_1_image', '.png'] , 'PNG');
    end
