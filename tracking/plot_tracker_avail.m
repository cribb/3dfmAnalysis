function h = plot_tracker_avail(frame, beadID, h, optstring)   
% PLOT_TRACKER_AVAIL Plots tracker ID vs. frame number for spot tracker data
%
% 3DFM function
% tracking
% last modified 11/01/13 (cribb)
%  
%  h = plot_tracker_avail(frame, beadID, h, optstring)  
%   
