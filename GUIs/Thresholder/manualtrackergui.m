function varargout = ManualTrackerGUI(varargin)
% MANUALTRACKERGUI Application M-file for ManualTrackerGUI.fig
%    FIG = MANUALTRACKERGUI launch ManualTrackerGUI GUI.
%    MANUALTRACKERGUI('callback_name', ...) invoke the named callback.

% Last Modified by GUIDE v2.0 08-Jun-2003 15:23:43
...
function varargout = pushbutton3_Callback(h, eventdata, handles, varargin)
 ...
 cal_file = get(handles.edit5,'String');
 ...
 good_string = strcat('Current calibration:  ', num2str(handles.calibration));
  ...
  set(handles.edit5,'String', good_string);
...
set(handles.edit5,'String', file_name);
...
% --------------------------------------------------------------------
function varargout = Calibration_Callback(h, eventdata, handles, varargin)
